"use strict";(()=>{var e={};e.id=541,e.ids=[541],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},12973:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>y,patchFetch:()=>h,requestAsyncStorage:()=>f,routeModule:()=>x,serverHooks:()=>m,staticGenerationAsyncStorage:()=>g});var o={};t.r(o),t.d(o,{POST:()=>u,dynamic:()=>l});var s=t(49303),a=t(88716),n=t(60670),i=t(82591),p=t(87070),d=t(76995);let l="force-dynamic",c=new i.R(process.env.RESEND_API_KEY);async function u(e){try{let{name:r,email:t,phone:o,insuranceType:s,message:a,website:n}=await e.json();if(n&&""!==n.trim())return d.O.from("inquiries").insert({source:"farmers",name:r,email:t,phone:o,insurance_type:s,message:a}).then(({error:e})=>{e&&console.error("Supabase log error:",e)}),p.NextResponse.json({success:!0},{status:200});if(!r||!t)return p.NextResponse.json({error:"Missing required fields."},{status:400});let{error:i}=await c.emails.send({from:"Insurance Wheatridge <noreply@mail.insurancewheatridge.com>",to:["jterry1@farmersagent.com"],replyTo:t,subject:`New Farmers Quote Request — ${r}`,html:`
      ...
      `});if(i)return console.error("Resend error:",i),p.NextResponse.json({error:"Failed to send message."},{status:500});return d.O.from("inquiries").insert({source:"farmers",name:r,email:t,phone:o,insurance_type:s,message:a}).then(({error:e})=>{e&&console.error("Supabase log error:",e)}),p.NextResponse.json({success:!0},{status:200})}catch(e){return console.error("API error:",e),p.NextResponse.json({error:"Server error."},{status:500})}}let x=new s.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/farmers-contact/route",pathname:"/api/farmers-contact",filename:"route",bundlePath:"app/api/farmers-contact/route"},resolvedPagePath:"/tmp/iw/nextjs-site/app/api/farmers-contact/route.js",nextConfigOutput:"",userland:o}),{requestAsyncStorage:f,staticGenerationAsyncStorage:g,serverHooks:m}=x,y="/api/farmers-contact/route";function h(){return(0,n.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:g})}},76995:(e,r,t)=>{t.d(r,{O:()=>a});var o=t(37857);let s=null,a=new Proxy({},{get:(e,r)=>(...e)=>(s||(s=(0,o.eI)(process.env.SUPABASE_URL,process.env.SUPABASE_SERVICE_ROLE_KEY)),s)[r](...e)})}};var r=require("../../../webpack-runtime.js");r.C(e);var t=e=>r(r.s=e),o=r.X(0,[948,572,591,70],()=>t(12973));module.exports=o})();