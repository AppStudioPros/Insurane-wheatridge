        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white p-8 lg:p-12 rounded-lg shadow-md">
            ...
            <div className="space-y-8 text-gray-700 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">No Guarantee of Coverage</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Agency Relationship</h2>
                <p>
