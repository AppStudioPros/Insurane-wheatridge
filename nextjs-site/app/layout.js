...
export const metadata = {
  ...
  title: {
    default: 'Insurance Wheat Ridge | Farmers Insurance Agent J. Terry | Wheat Ridge, CO',
  ...
  openGraph: {
    ...
    title: 'Insurance Wheat Ridge | Farmers Insurance Agent J. Terry | Wheat Ridge, CO',
    description: 'Your local Farmers Insurance agent in Wheat Ridge, Colorado. Auto, home, life, business, renters, and condo insurance. Get a free quote today.',
    images: [{
